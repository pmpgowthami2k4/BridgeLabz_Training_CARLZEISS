...
//            return await _noteDL.CreateNote(note);
//        }
...
//        {
//            return await _noteDL.RestoreNote(noteId, userId);
//        }

//        public async Task<bool> DeletePermanently(int noteId, int userId)
//        {
//            return await _noteDL.DeletePermanently(noteId, userId);
//        }
...
//        {
//            return await _noteDL.UpdateNote(noteId, userId, dto);
//        }

//        public async Task<bool> ArchiveNote(int noteId, int userId)
//        {
//            return await _noteDL.ArchiveNote(noteId, userId);
//        }

//        public async Task<bool> UnarchiveNote(int noteId, int userId)
//        {
//            return await _noteDL.UnarchiveNote(noteId, userId);
//        }
...
//        {
//            return await _noteDL.PinNote(noteId, userId);
//        }

//        public async Task<bool> UnpinNote(int noteId, int userId)
//        {
//            return await _noteDL.UnpinNote(noteId, userId);
//        }

//        public async Task<bool> ChangeColor(int noteId, int userId, string colour)
//        {
//            return await _noteDL.ChangeColor(noteId, userId, colour);
//        }
